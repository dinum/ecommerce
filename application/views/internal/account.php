<section class="post-area section-gap">
    <div class="card width50">
            <div class="row">
                ...
                <form action="<?php echo base_url(); ?>home/account" method="POST" style="width: 100%;">
                    <input type="hidden" value="<?php echo $cid; ?>" name="cid" />
                        ...
                        <div class="mt-10">
                            <input name="mobile" value="<?php echo (isset($data['mobile'])) ? $data['mobile'] : ""; ?>" placeholder="Enter Mobile Number" pattern="[0-9]{9,10}$" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Mobile Number'" class="single-input" required type="text">
                        ...
                        <input type="submit" name="submitdata" value="Update" class="btn btn-primary" />
                    </form>
